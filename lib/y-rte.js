...
Selection = (function() {
  function Selection(a, b, c, d, e) {
    ...
    if ((a != null) && (b != null) && (c != null) && (d != null)) {
      ...
      c.constructor === "Rte";
      ref = this.relativeFromAbsolute(a, b, c), this.startPos = ref[0], this.endPos = ref[1];
      attr = d;
    } else if ((a != null) && (b != null) && (a.pos != null) && (a.word != null) && (b.pos != null) && (b.word != null)) {
      this.startPos = a;
      this.endPos = b;
      attr = c;
    } else {
      throw new Error("Wrong set of parameters " + [a, b, c, d, e]);
    }
    if (attr != null) {
      this.attr = attr;
    }
  ...
  Selection.prototype.clone = function() {
    return new Selection(this.startPos, this.endPos);
  };
